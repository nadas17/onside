    ...
    <div ref={ref} className="relative">
      ...
      {open && (
        <div
          role="dialog"
          aria-label={t("title")}
          className="border-border bg-popover absolute top-full right-0 z-50 mt-2 flex w-80 max-w-[calc(100vw-2rem)] flex-col overflow-hidden rounded-md border shadow-lg"
        >

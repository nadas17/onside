/**
 * Phase 2 venue seed (Warsaw + Gdańsk gerçek halı sahalar).
 *
 * Kullanım:
...
const VENUES = [
  // --- Warsaw ---
  {
    ...
    externalUrl: "https://arenafutbolu.pl/",
  },
  {
    name: "Soccer Arena Annopol",
    addressLine: "ul. Annopol 24B",
    city: "Warsaw",
    lat: 52.31532,
    lng: 21.0151,
    surface: "indoor",
    ...
    externalUrl: "https://soccerarena.pl/",
  },
  {
    name: "RS Sport Chodakowska",
    addressLine: "ul. Chodakowska 24",
    city: "Warsaw",
    lat: 52.25003,
    lng: 21.06693,
    surface: "artificial",
    hasFloodlights: true,
    isCovered: true,
    approxPricePerHour: 230,
    externalUrl: "https://www.rssport.pro/",
  },
  {
    name: "Centrum Futbolu Warszawianka",
    addressLine: "ul. Merliniego 2",
    city: "Warsaw",
    lat: 52.19656,
    lng: 21.02626,
    surface: "artificial",
    hasFloodlights: true,
    isCovered: false,
    approxPricePerHour: 280,
    externalUrl: "https://www.boiskawarszawianki.pl/",
  },
  {
    name: "Olimpijski FC Warszawa",
    addressLine: "ul. Podróżnicza 11",
    city: "Warsaw",
    lat: 52.32632,
    lng: 20.97315,
    surface: "indoor",
    ...
    externalUrl: "https://olimpijskifc.pl/warszawa/",
  },
  {
    name: "Estadio De Ubocze",
    addressLine: "ul. Na Uboczu 9",
    city: "Warsaw",
    lat: 52.13954,
    lng: 21.04889,
    surface: "artificial",
    ...
    externalUrl: "https://www.estadiodeubocze.pl/",
  },
  {
    name: "Hala Piłkarska Marymont",
    addressLine: "ul. Księcia Bolesława 1/3",
    city: "Warsaw",
    lat: 52.25214,
    lng: 20.93821,
    surface: "indoor",
    hasFloodlights: true,
    isCovered: true,
    approxPricePerHour: 350,
    externalUrl: "http://halapilkarska.pl/",
  },
  {
    name: "Boisko OSiR Targówek Łabiszyńska",
    addressLine: "ul. Łabiszyńska 20",
    city: "Warsaw",
    lat: 52.29887,
    lng: 21.03249,
    surface: "artificial",
    ...
    externalUrl: "https://sport.um.warszawa.pl/waw/osir-targowek/",
  },
  {
    name: "Orlik Wilanów Worobczuka",
    addressLine: "ul. Adama Worobczuka 8",
    city: "Warsaw",
    lat: 52.15471,
    lng: 21.06704,
    surface: "artificial",
  ...
  {
    name: "Orlik Ursynów Przy Bażantarni",
    addressLine: "ul. Przy Bażantarni 3",
    city: "Warsaw",
    lat: 52.13735,
    lng: 21.06579,
    surface: "artificial",
    ...
    isCovered: false,
    approxPricePerHour: 0,
    externalUrl: "https://sport.um.warszawa.pl/waw/ucsir/",
  },
  // --- Gdańsk ---
  {
